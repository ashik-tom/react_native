...
import styles from "../RaisesosStyles";
...
function LowerSos(props) {
    ...
    return (
        <View style={styles.container}>
            ...
            <Text style={styles.header}>Lower SOS</Text>
            ...
            <View style={styles.cont2}>
                <Text style={styles.textW1}>Have you completely recovered from illness</Text>
                <Icons name="check-circle" size={30} color={"green"}/>
            </View>
            <View style={styles.cont3}>
                <Text style={styles.textW2}>Are you completely out of danger</Text>
            ...
            <View style={styles.docPickCont}>
                ...
                <Text style={styles.text3}>Upload files(rtpcr,testreport etc.)</Text>
                </Pressable>
            ...
            <Text style={{color:"white",fontSize:24,fontWeight:"normal"}}>Lower SOS</Text>    
            </TouchableHighlight> 
